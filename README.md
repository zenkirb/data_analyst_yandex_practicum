...
|13  | Прогноз оттока клиентов фитнес-цента | Проводим анализ клиентов фитнес-центра и составляем портреты клиентов. Разрабатываем модель машинного обучения для прогнозирования оттока клиентов в фитнес-центре. Навыки: машинное обучение, кластеризация, классификация, логистическая регрессия, случайный лес | Pandas, NumPy, Seaborn, Matplotlib, SciPy, Scikit-learn |
